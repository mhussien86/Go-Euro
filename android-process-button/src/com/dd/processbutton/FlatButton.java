...
public class FlatButton extends Button
{
	...
	private void initAttributes(Context context, AttributeSet attributeSet)
	{
		...
		try
		{
			...
			cornerRadius = attr.getDimension(
					R.styleable.FlatButton_cornerRadius, defValue);
	...
	private LayerDrawable createNormalDrawable(TypedArray attr)
	{
		...
		int colorPressed = attr.getColor(R.styleable.FlatButton_colorPressed,
				blueDark);
		...
		int colorNormal = attr.getColor(R.styleable.FlatButton_colorNormal,
				blueNormal);
